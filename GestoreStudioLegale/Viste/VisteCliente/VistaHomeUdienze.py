...
class VistaHomeUdienze(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        textLabel3 = QLabel()
        textLabel3.setText('Udienza: '+'\n'+ 'CITTA TRIBUNALE: '+f"{self.getDatiU()['Città Tribunale']}"+ '\n'+'DATA E ORA INIZIO: '+f"{self.getDatiU()['Data e Ora Inizio']}"+'\n'+'DATA E ORA FINE: '+f"{self.getDatiU()['Data e Ora Fine']}"+'\n'+'ID: '+f"{self.getDatiU()['ID']}"+ 'TIPO TRIBUNALE: '+f"{self.getDatiU()['Tipo Tribunale']}")
    ...
    def getDatiU(self):
        ...
        for udienza in self.udienzeList:
            print(str(tool.leggi()).rsplit()[0])
            print(self.getDatiC()['Codice fiscale'])
            if self.getDatiC()['Codice fiscale'] == str(tool.leggi()).rsplit()[0]:
    ...
    def getDatiC(self):
        ...
        for cliente in self.clientiList:
            ...
            if cliente.codiceFiscale == str(tool.leggi(n=0)).rsplit()[0]:
                ...
                return cliente1.getDatiCliente()
